...
describe("eslint-config-premisehealth", () => {
  ...
  it("enforces no-unused-vars", () => {
    ...
    expect(msg.severity).to.equal(1);
    expect(msg.message).to.match(
      /'internals2' is assigned a value but never used\./
    );
  ...
  it("enforces no-useless-computed-key rule", () => {
    ...
    expect(msg.severity).to.equal(2);
    expect(msg.message).to.equal(
      "Unnecessarily computed property ['0'] found."
    );
    expect(msg.line).to.equal(2);
    expect(msg.column).to.equal(22);
    expect(msg.nodeType).to.equal("Property");
    ...
    expect(msg.severity).to.equal(2);
    expect(msg.message).to.equal(
      "Unnecessarily computed property ['0+1,234'] found."
    );
    expect(msg.line).to.equal(3);
    expect(msg.column).to.equal(22);
    expect(msg.nodeType).to.equal("Property");
    ...
    expect(msg.severity).to.equal(2);
    expect(msg.message).to.equal(
      "Unnecessarily computed property ['x'] found."
    );
